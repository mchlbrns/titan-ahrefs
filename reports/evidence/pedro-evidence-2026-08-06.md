...
**Generated:** 2026-08-06T08:36:06.249Z
**API Mode:** LIVE AHREFS API v3 (MOCK_API_FALLBACK=false)
**Run ID:** pedro-evidence-2026-08-06-1786005343707
...
```json
{
  "request": {
    ...
    "timestamp": "2026-08-06T08:35:43.710Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
    ...
    "bodySample": {
      "limits_and_usage": {
        ...
        "units_usage_workspace": 17319,
        "units_limit_api_key": null,
        "units_usage_api_key": 17319,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:44.400Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:44.402Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:45.706Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:47.028Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:48.527Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:50.017Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:51.232Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:51.233Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:51.235Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:53.059Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:55.021Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:55.568Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:58.099Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:58.577Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:58.578Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:58.579Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:35:59.682Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:36:00.246Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:36:01.159Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "request": {
    ...
    "authorization": "Bearer [REDACTED]",
    "timestamp": "2026-08-06T08:36:04.268Z"
  },
  "responseSample": {
    "status": 200,
    "ok": true,
...
```json
{
  "snapshotId": "snap_red-engage_com_live_1786005351230",
  "domain": "red-engage.com",
  "timestamp": "2026-08-06T08:35:51.230Z",
  "dataSource": "ahrefs-api-v3",
  "domainRating": 26,
  "referringDomains": 426,
  "totalBacklinks": 750,
  "estimatedTraffic": 0,
  "organicKeywords": 3,
  "requirementCoverage": {
...
```json
{
  "snapshotId": "snap_heavengirlfriend_com_live_1786005358575",
  "domain": "heavengirlfriend.com",
  "timestamp": "2026-08-06T08:35:58.575Z",
  "dataSource": "ahrefs-api-v3",
  "domainRating": 21,
...
```json
{
  "snapshotId": "snap_hornycompanion_com_live_1786005366245",
  "domain": "hornycompanion.com",
  "timestamp": "2026-08-06T08:36:06.245Z",
  "dataSource": "ahrefs-api-v3",
  "domainRating": 2.4,
...
```json
{
  "domain": "red-engage.com",
  "trendDirection": "UP",
  "previousTimestamp": "2026-08-06T02:18:34.139Z",
  "currentTimestamp": "2026-08-06T08:35:51.230Z",
  "drChange": 26,
  "trafficChange": 0,
  "kwChange": 0,
  "refdomsChange": 5,
...
```json
{
  "domain": "heavengirlfriend.com",
  "trendDirection": "UP",
  "previousTimestamp": "2026-08-06T02:18:38.692Z",
  "currentTimestamp": "2026-08-06T08:35:58.575Z",
  "drChange": 21,
  "trafficChange": 0,
  "kwChange": 0,
  "refdomsChange": 0,
...
```json
{
  "domain": "hornycompanion.com",
  "trendDirection": "UP",
  "previousTimestamp": "2026-08-06T02:18:43.044Z",
  "currentTimestamp": "2026-08-06T08:36:06.245Z",
  "drChange": 2.4,
  "trafficChange": 0,
  "kwChange": 0,
  "refdomsChange": 0,
